            ...
            <Chip
                ...
                icon={
                    <Avatar
                        ...
                        src={user?user.avatar:"https://i.pinimg.com/originals/24/58/5f/24585fc9b7433a224a6ff5506e346969.png"}
                        sx={{
                                    ...
                                    <MainCard border={false} elevation={16} content={false} boxShadow shadow={theme.shadows[16]}>
                                        <Box sx={{ p: 2, pb: 0 }}>
                                            <Stack>
                                                ...
                                                <Typography variant="subtitle2">{primerRoll}</Typography>
                                        ...
                                        >
                                            <Box sx={{ p: 2, pt: 0 }}>
                                                ...
                                                {/* TARJETA DE PLAN DE Divider */}
                                                {/* <UpgradePlanCard />
                                                <Divider /> */}



                                                {/* CARD DE Start DND Mode    Allow Notifications */}
                                                {/* <Card
                                                    sx={{
                                                        bgcolor:
