        ...
        <Grid item xs={12}>
          <Grid container spacing={gridSpacing}>
            <Grid item xs={11}>
              <Typography
                variant="h3"
                color={presupuestador.estHeader.status<=15?(theme.palette.mode === "dark" ? "white" : "black"):("coral")}
                display={"inline"}
              >
                {presupuestador.estHeader.status<=15?("INBOUND >>> Descripcion: "):("INBOUND (Importado, a revisar) - Descripcion: ")}
              </Typography>
              <Typography
                variant="h3"
                ...
                <AnimateButton>
                  <Button
                    ...
                    sx={{
                      ...
                      top: "-40px", // Posición desde la parte superior del contenedor
                      spacing: "25px",
                  ...
                  <AnimateButton>
                    <Button
                      ...
                      sx={{
                        ...
                        position: "relative", // Posición relativa  PARA COLOCAR EL BOTON A LA ALTURA DEL MAINCARD
                        top: "-40px", // Posición desde la parte superior del contenedor
                        right: "20px", // Posición desde la derecha del contenedor
                        //margin: "-25px",
          ...
          >
            ...
            >
              <Grid item xs={12} sm={8} md={11}>
                <TablaContenedores
                // POR FAVOR CORTALA CON LOS ENTERS EN LAS EXPRESIONES LOGICAS !!!!. 
            ...
            <Table>
              ...
              <TableBody>
                ...
                <TableRow>
                  ...
                  <TableCell className={classes.tableCellBodyListaDetalle}>
                    <Chip
                      sx={{ minWidth: "80px" }}
                      label={estados.find(estado => estado.id === presupuestador?.estHeader?.status)?.description || "Estado no encontrado" }                      
                      //variant="outlined"
                      size="small"
                      //chipcolor="warning"
                    />
                ...
                <TableRow>
                  ...
                  <TableCell className={classes.tableCell}>
                    {presupuestador?.estHeader?.carrier
                      ? presupuestador.estHeader.carrier
                      : "Sin Especificar"}
                  </TableCell>
                </TableRow>
