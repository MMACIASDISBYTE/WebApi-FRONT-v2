...
const Historico = ({ presupuestador, usuario, historico }) => {
          ...
          <Grid container spacing={gridSpacing} >
            {/* <Grid item xs={12}>
              <Grid container spacing={0}>
                 <Grid item xs={12}>
                  <Typography variant="subtitle1">Presupuestador: </Typography>
                </Grid>
                <Grid item xs={12}>
                  <Typography variant="body2">{usuario.name}.</Typography>
                </Grid>
                <Grid item xs={12}>
                          ...
                          <Chip
                            label={
                              ...
                              presupuestador.estHeader.status == 0
                                ? `Estado n° ${presupuestador.estHeader.status}`
                                : "Sourcing"
                            }
                            variant="outlined"
                            size="small"
