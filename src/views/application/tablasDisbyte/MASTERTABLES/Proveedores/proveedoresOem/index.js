...
// ==============================|| Proveedores Oem LIST ||============================== //

const ProductList = () => {
    const navigate = useNavigate();
    const theme = useTheme();
    const TableName = 'Proveedores Oem';
    ...
    const fetchData = async (accessToken) => {
        try {
            const jsonData = await ProveedoresOemHelper.fetchData();
    ...
    const handleDelete = async (id, description) => {
        ...
        await ProveedoresOemHelper.deleteDataById(id);
        // para actualizar el componente
        SetActualizacion(true);
        console.log(`El fwette ${description} con ${id}, ha sido eliminado`);
    };

    const handleCreateAPI = async (newData) => {
        await ProveedoresOemHelper.createData(newData);
    };
    // Función para actualizar la API utilizando
    const handleUpdateAPI = async (id, data) => {
        await ProveedoresOemHelper.updateDataById(id, data);
    };
