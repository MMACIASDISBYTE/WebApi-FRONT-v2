...
import { SeguroHelper } from '../../../../../../helpers/SeguroHelper';
...
const ProductList = () => {
    ...
    const fetchData = async (accessToken) => {
        try {
            const jsonData = await SeguroHelper.fetchData();
    ...
    const handleDelete = async (id, description) => {
        ...
        await SeguroHelper.deleteDataById(id);
        // para actualizar el componente
        SetActualizacion(true);
        console.log(`El Seguro ${description} con ${id}, ha sido eliminado`);
    };

    const handleCreateAPI = async (newData) => {
        await SeguroHelper.createData(newData);
    };
    // Función para actualizar la API utilizando
    const handleUpdateAPI = async (id, data) => {
        await SeguroHelper.updateDataById(id, data);
    };
