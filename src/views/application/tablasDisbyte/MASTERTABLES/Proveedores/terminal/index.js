...
const ProductList = () => {
    ...
    const fetchData = async (accessToken) => {
        try {
            const jsonData = await TerminalHelper.fetchData();
    ...
    const handleDelete = async (id, description) => {
        ...
        await TerminalHelper.deleteDataById(id);
    ...
    const handleCreateAPI = async (newData) => {
        await TerminalHelper.createData(newData);
    };
    // Función para actualizar la API utilizando
    const handleUpdateAPI = async (id, data) => {
        await TerminalHelper.updateDataById(id, data);
    };
