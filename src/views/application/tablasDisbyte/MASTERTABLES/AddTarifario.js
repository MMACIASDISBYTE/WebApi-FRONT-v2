...
const AddTarifario = ({
  ...
  const excludedColumns = [
    ...
    "carga_vista",
    "terminal_vista",
    "flete_interno_1p40sthq_cdmx",
    "flete_interno_1p20ft_cdmx",
    "flete_interno_2p40sthq_cdmx",
    "flete_interno_2p20ft_cdmx",
    "descarga_meli_40sthq_cdmx",
    "descarga_meli_20ft_cdmx",
    // "htimestamp",
  ];
          ...
          <DialogContent>
            <Grid container spacing={gridSpacing} sx={{ mt: 0.25 }}>
              {headCells
                ...
                .map((cell) => (
                  <Grid item xs={12} sm={2} key={cell.id}>
                    {cell.id !== "id" && (
                      <>
                        ...
                        {cell.select === "paisRegion" ? (
                          ...
                          <TextField
                            ...
                            disabled={cell.isDisabled ? true : false}
                            name={cell.id}
                            value={dataValues[cell.id] || parseFloat(row[cell.id])}
                            placeholder={`Ingrese ${cell.label}${
                              cell.isRequired ? " *Requerido" : ""
                            }`}
                            onChange={handleChange}
...
AddTarifario.propTypes = {
  open: PropTypes.bool,
  handleCloseDialog: PropTypes.func,
};
export default AddTarifario;
