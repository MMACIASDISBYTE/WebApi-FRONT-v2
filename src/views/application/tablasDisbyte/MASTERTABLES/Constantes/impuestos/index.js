...
import { ImpuestoHelper } from '../../../../../../helpers/ImpuestoHelper';
...
const ProductList = () => {
    ...
    const fetchData = async (accessToken) => {
        try {
            const jsonData = await ImpuestoHelper.fetchData();
