...
const ProductList = () => {
    ...
    const fetchData = async (accessToken) => {
        try {
            ...
            const [jsonData, jsonDataStatus] = await CanalHelper.fetchData();
    ...
    const handleDelete = async (id, description) => {
        ...
        await CanalHelper.deleteDataById(id);
    ...
    const handleCreateAPI = async (newData) => {
        await CanalHelper.createData(newData);
    }

    // Función para actualizar la API utilizando 
    const handleUpdateAPI = async (id, data) => {
        await CanalHelper.updateDataById(id, data);
    };
